...
export async function GET() {
  ...
  lines.push(
    prometheusLine(
      "vibe_http_errors_total",
      "Total 5xx errors since process start",
      "gauge",
      [String(errorCount)]
    )
  );
  ...
  lines.push(
    prometheusLine(
      "vibe_products_active",
      "Number of active products in catalog",
      "gauge",
