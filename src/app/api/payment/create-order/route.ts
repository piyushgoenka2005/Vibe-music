...
import { enforceMutationSecurity, enforceRateLimit, parseJsonBody } from "@/lib/api/route-utils";
...
export async function POST(request: Request) {
  try {
    ...
    const status = /Insufficient stock|Cart is empty|required|Invalid payment method/i.test(message)
      ? 400
      : 500;
