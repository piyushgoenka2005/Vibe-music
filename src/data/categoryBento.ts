...
const BENTO_IMAGE_FILES: Record<string, string> = {
  ...
  "microphones-wireless": `${CAT}/SM58-cat.png`,
...
export const CATEGORY_BENTO_ITEMS: CategoryBentoItem[] = [
  ...
  },
  {
    ...
    title: "Microphones",
    desc: "Dynamic • Condenser • Wireless",
    size: "small",
    variant: "image-card",
    image: resolveBentoImage("microphones-wireless"),
    imageSrcSet: resolveBentoSrcSet("microphones-wireless"),
    imageSizes: resolveBentoSizes(),
