...
export const ROUTES = {
  ...
  used: "/used",
  rentals: "/rentals",
  rentalCategory: (slug: string) => `/rentals/category/${slug}`,
  rentalProduct: (slug: string) => `/rentals/${slug}`,
  rentalCheckout: "/rentals/checkout",
  accountRentals: "/account/rentals",
  accountRental: (id: string) => `/account/rentals/${id}`,
  adminRentals: "/admin/rentals",
  adminRentalProducts: "/admin/rentals/products",
  adminRentalCategories: "/admin/rentals/categories",
  adminRentalBookings: "/admin/rentals/bookings",
  adminRentalAnalytics: "/admin/rentals/analytics",
