...
from User.models import buyModel
...
def dashboard(request):
    total_orders = buyModel.objects.count()
    pending_orders = buyModel.objects.filter(order_status='pending').count()
    ...
    return render(request, 'admin/dashboard.html', items)
