...
| Razorpay               | `RAZORPAY_KEY_ID`, `RAZORPAY_KEY_SECRET`, `NEXT_PUBLIC_RAZORPAY_KEY_ID` — must be **`rzp_live_…`** on vibemusic.in (`rzp_test_…` shows Test Mode and is rejected) | Online pay hidden                |
